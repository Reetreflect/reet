...
BOOST_AUTO_TEST_CASE(test_addresses)
{
    ...
    std::vector<std::string> pubkey = {"reflect:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "reflect:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "reflect:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {"reflect:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "reflect:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "reflect:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
