...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"reflectaddress\"\n"
            "\nReveals the private key corresponding to 'reflectaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"reflectaddress\"   (string, required) The reflect address for the private key\n"
            "\nResult:\n"
