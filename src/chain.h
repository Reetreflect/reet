...
enum BlockStatus: uint32_t {
    ...
    BLOCK_HAVE_DATA          =    8, //!< full block available in reet*.dat
...
public:
    ...
    //! Which # file this block is stored in (reet?????.dat)
    int nFile;

    //! Byte offset within reet?????.dat where this block's data is stored
