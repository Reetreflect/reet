...
const QString BITCOIN_IPC_PREFIX("reflect:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/reflect-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/reflect-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/reflect-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click reflect: links
...
//
// OSX-specific way of handling reflect: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in reflect: URIs
