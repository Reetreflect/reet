    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextBlackmore   = QChar(0xA9)+QString(" %1-%2 ").arg(2014).arg(2018) + QString("The Reflect developers");
    QString copyrightTextReflect   = QChar(0xA9)+QString(" %1-%2 ").arg(2018).arg(COPYRIGHT_YEAR) + QString("The Reflect Core developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+10,copyrightTextReflect);
        pixPaint.drawText(x,y+20,copyrightTextReflect);
    }
